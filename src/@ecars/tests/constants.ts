...
export type ErrorTestCasesType = [string, unknown, string];
export type ComplexErrorTestCasesType = keyof typeof errorTestConfig.getErrorMessage.complex;
export const errorTestConfig = {
  getErrorMessage: {
    complex: {
      serverError: {
        status: 500,
